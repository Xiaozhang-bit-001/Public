...
# 注意：需确保config.py、resnet_skip_new.py、model_resnet.py这三个文件存在
...
class Attention(nn.Module):
    def __init__(self, config, vis):
        ...
        self.attn_dropout = Dropout(0.2)  # 增强正则化
...
class Mlp(nn.Module):
    def __init__(self, config):
        ...
        self.dropout = Dropout(0.3)  # 增强正则化
