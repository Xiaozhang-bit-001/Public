...
# 模型配置
MODEL_NAME = 'FCN'
MODEL_WEIGHT_PATH = r"/root/autodl-tmp/Geo-SegViT/ComparedModels_U/FCN_V/best.pth"
...
# 输出配置
OUTPUT_DIR = r'/root/autodl-tmp/Geo-SegViT/TestResults/FCN_V'
...
def main():
    ...
    test_dataset = FCNTestDataset(ROOT_PATH, transform=transform)
    test_loader = DataLoader(test_dataset, batch_size=BATCH_SIZE, shuffle=False, num_workers=0)

    model = FCN(num_classes=NUM_CLASSES, in_channels=IN_CHANNELS).to(DEVICE)
