...
ROOT_PATH = r'G:\erya308\zhangjunming\Geo-SegViT\datasets\Vaihingen\npz_data_RGB_improved'
MODEL_WEIGHT_PATH = r"G:\erya308\zhangjunming\modeL\Geo-SegViT\ComparedModel2_Best\SegViTRS_Improved_Vai_networks\SegViTRS_Improved_Vai_256_256\iter30k_epo150_bs8_lr0.01_s1234\best_model.pth"
CONFIG_PATH = r"G:\erya308\zhangjunming\Geo-SegViT\Datasets\Vaihingen\Geo_SegViT_Vai_config.json"
...
# 输出配置
OUTPUT_DIR = r'G:\erya308\zhangjunming\Geo-SegViT\ComparedModels\TestResults\Geo-SegViT_V'
...
def main():
    ...
    # ===================== 加载你的 SegViTRS_Improved 模型 =====================
    print("\n🔧 加载 SegViTRS_Improved 模型...")
    # 导入你的模型（确保模型文件在正确路径）
    # from 你的模型文件 import SegViTRS_Improved
    # 如果你把模型代码和测试代码放在同一个文件，直接使用即可
